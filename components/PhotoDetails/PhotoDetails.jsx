        ...
        <div className="mt-6">
          <div className="flex justify-between items-center mb-3">
            <div className="flex items-center gap-3">
              <Image width={50} height={50} className="size-12 lg:size-14 rounded-full border" src={photo.author.avatar} alt="avatar" />
            ...
            <button className="flex items-center gap-1.5 text-black/60 text-xs xl:text-sm">
              <Image width={50} height={50} src="/icons/follow.svg" className="w-5 h-5" alt='follow' />
              {dictionary.follow}
            </button>
          </div>
        ...
        <div className="mt-6">
          <div className="flex items-stretch gap-3">
            <button
              ...
              <Image width={50} height={50} src="/icons/heart.svg" className="w-5 h-5" alt='heart' />
              {photo.likes}
            </button>
            <button
              className="flex-1 border py-1.5 rounded text-xs lg:text-sm flex items-center justify-center text-center gap-1.5 font-bold hover:bg-yellow-400">
              <Image width={50} height={50} src="/icons/save.svg" className="w-5 h-5" alt='save' />
              {dictionary.save}
            </button>
            <button
              className="flex-1 border py-1.5 rounded text-xs lg:text-sm flex items-center justify-center text-center gap-1.5 font-bold hover:bg-yellow-400">
              <Image width={50} height={50} src="/icons/share.svg" className="w-5 h-5" alt='share' />
